...
# Ferramentas aprimoradas para controle do Spotify, com tratamento de input robusto.
...
def play_music_on_spotify(song_name: str, artist_name: str = None) -> str:
    ...
    try:
        ...
        print(f"❌ ERRO em play_music_on_spotify: {e}"); traceback.print_exc()
...
def control_spotify_playback(action: str) -> str:
    ...
    try:
        ...
        print(f"❌ ERRO em control_spotify_playback: {e}"); traceback.print_exc()
        if "Connection aborted" in str(e):
            return "A conexão com o Spotify foi perdida. Por favor, tente novamente."
